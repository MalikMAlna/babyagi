...
import openai
from extensions.components.IContextStorage import ContextStorage, StorageOptions, ContextResult, ContextData
...
class PineconeTaskStorage(ContextStorage):
    ...
    def __init__(self, storage_name: Optional[str] = None, options: Optional[PineconeOptions] = None):
        ...
        if options is None:
            options = PineconeTaskStorage.PineconeOptions(storage_name=storage_name)
